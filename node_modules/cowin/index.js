...
async function getStates() { /* https://apisetu.gov.in/public/marketplace/api/cowin/cowin-public-v2#/Metadata%20APIs/states */
    return axios({
        method: 'get',
        url: 'https://cors-anywhere.herokuapp.com/https://cdn-api.co-vin.in/api/v2/admin/location/states',
        headers: {
...
async function getListofDistricts(states_id) { /* https://apisetu.gov.in/public/marketplace/api/cowin/cowin-public-v2#/Metadata%20APIs/districts */
    return axios({
        method: 'get',
        url: `https://cors-anywhere.herokuapp.com/https://cdn-api.co-vin.in/api/v2/admin/location/districts/${states_id}`,
        headers: {
            'accept': 'application/json',
            'Accept-Language': 'en_US',
            'User-Agent': 'Mozilla/5.0 (iPhone; CPU iPhone OS 13_2_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/13.0.3 Mobile/15E148 Safari/604.1'
...
async function findByPin(pincode, date) { /* https://apisetu.gov.in/public/marketplace/api/cowin/cowin-public-v2#/Appointment%20Availability%20APIs/findByPin */
    return axios({
        method: 'get',
        url: `https://cors-anywhere.herokuapp.com/https://cdn-api.co-vin.in/api/v2/appointment/sessions/public/findByPin?pincode=${pincode}&date=${date}`,
        headers: {
            'accept': 'application/json',
            'Accept-Language': 'en_US',
            'User-Agent': 'Mozilla/5.0 (iPhone; CPU iPhone OS 13_2_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/13.0.3 Mobile/15E148 Safari/604.1'
...
async function findByDistrict(district_id, date) { /* https://apisetu.gov.in/public/marketplace/api/cowin/cowin-public-v2#/Appointment%20Availability%20APIs/findByDistrict */
    return axios({
        method: 'get',
        url: `https://cors-anywhere.herokuapp.com/https://cdn-api.co-vin.in/api/v2/appointment/sessions/public/findByDistrict?district_id=${district_id}&date=${date}`,
        headers: {
            'accept': 'application/json',
            'Accept-Language': 'en_US',
            'User-Agent': 'Mozilla/5.0 (iPhone; CPU iPhone OS 13_2_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/13.0.3 Mobile/15E148 Safari/604.1'
...
async function calendarByDistrict(district_id, date) { /* https://apisetu.gov.in/public/marketplace/api/cowin/cowin-public-v2#/Appointment%20Availability%20APIs/calendarByDistrict */
    return axios({
        method: 'get',
        url: `https://cors-anywhere.herokuapp.com/https://cors-anywhere.herokuapp.com/https://cdn-api.co-vin.in/api/v2/appointment/sessions/public/calendarByDistrict?district_id=${district_id}&date=${date}`,
        headers: {
            'accept': 'application/json',
            'Accept-Language': 'en_US',
            'User-Agent': 'Mozilla/5.0 (iPhone; CPU iPhone OS 13_2_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/13.0.3 Mobile/15E148 Safari/604.1'
